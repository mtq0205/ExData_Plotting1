...
# First plot
plot(pcdata1$DateTime,pcdata1$Global_active_power,xlab="",ylab="Global Active Power",type="l")

# Second plot
plot(pcdata1$DateTime,pcdata1$Voltage,xlab="",ylab="Voltage",type="l")
...
# Fourth plot
plot(pcdata1$DateTime,pcdata1$Global_reactive_power,xlab="datetime",ylab = "Global_reactive_power",type="l")
